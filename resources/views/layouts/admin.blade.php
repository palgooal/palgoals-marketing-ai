        ...
        <aside class="w-full bg-slate-900 text-slate-100 lg:min-h-screen lg:w-64 lg:shrink-0">
            ...
            <nav class="space-y-1 px-3 py-6">
                ...
                <a href="{{ route('offers.index') }}"
                    class="{{ request()->routeIs('offers.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }} block rounded-lg px-3 py-2 text-sm font-medium transition">
                    Offers
                </a>

                <a href="{{ route('plans.index') }}"
                    class="{{ request()->routeIs('plans.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800/60 hover:text-white' }} block rounded-lg px-3 py-2 text-sm font-medium transition">
                    Plans
                </a>
